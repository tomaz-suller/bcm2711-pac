...
pub type GAPO1_W<'a, const O: u8> = crate::BitWriter<'a, STA_SPEC, O>;
...
pub type GAPO2_W<'a, const O: u8> = crate::BitWriter<'a, STA_SPEC, O>;
...
pub type GAPO3_W<'a, const O: u8> = crate::BitWriter<'a, STA_SPEC, O>;
