...
pub type RX_LEVEL_W<'a, const O: u8> = crate::FieldWriter<'a, STAT_SPEC, 4, O>;
...
pub type TX_LEVEL_W<'a, const O: u8> = crate::FieldWriter<'a, STAT_SPEC, 4, O>;
impl R {
