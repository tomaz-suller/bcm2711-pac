...
pub type KEEP_INPUT_W<'a, const O: u8> = crate::BitWriter<'a, CNTL1_SPEC, O>;
...
pub type MSB_FIRST_W<'a, const O: u8> = crate::BitWriter<'a, CNTL1_SPEC, O>;
...
pub type DONE_ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, CNTL1_SPEC, O>;
...
pub type TXE_ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, CNTL1_SPEC, O>;
...
pub type CS_HIGH_TIME_W<'a, const O: u8> = crate::FieldWriter<'a, CNTL1_SPEC, 3, O>;
impl R {
