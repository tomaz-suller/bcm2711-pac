...
pub type SHIFT_LENGTH_W<'a, const O: u8> = crate::FieldWriter<'a, CNTL0_SPEC, 6, O>;
...
pub type MSB_FIRST_W<'a, const O: u8> = crate::BitWriter<'a, CNTL0_SPEC, O>;
...
pub type INVERT_CLK_W<'a, const O: u8> = crate::BitWriter<'a, CNTL0_SPEC, O>;
...
pub type OUT_RISING_W<'a, const O: u8> = crate::BitWriter<'a, CNTL0_SPEC, O>;
#[doc = "Field `CLEAR_FIFOS` reader - Clear FIFOs"]
pub type CLEAR_FIFOS_R = crate::BitReader;
#[doc = "Field `CLEAR_FIFOS` writer - Clear FIFOs"]
pub type CLEAR_FIFOS_W<'a, const O: u8> = crate::BitWriter<'a, CNTL0_SPEC, O>;
...
pub type IN_RISING_W<'a, const O: u8> = crate::BitWriter<'a, CNTL0_SPEC, O>;
#[doc = "Field `ENABLE` reader - Enable the interface"]
pub type ENABLE_R = crate::BitReader;
#[doc = "Field `ENABLE` writer - Enable the interface"]
pub type ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, CNTL0_SPEC, O>;
...
pub type DOUT_HOLD_TIME_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, CNTL0_SPEC, 2, O, DOUT_HOLD_TIME_A>;
...
pub type VARIABLE_WIDTH_W<'a, const O: u8> = crate::BitWriter<'a, CNTL0_SPEC, O>;
...
pub type VARIABLE_CS_W<'a, const O: u8> = crate::BitWriter<'a, CNTL0_SPEC, O>;
...
pub type POST_INPUT_W<'a, const O: u8> = crate::BitWriter<'a, CNTL0_SPEC, O>;
...
pub type CHIP_SELECTS_W<'a, const O: u8> = crate::FieldWriter<'a, CNTL0_SPEC, 3, O>;
...
pub type SPEED_W<'a, const O: u8> = crate::FieldWriter<'a, CNTL0_SPEC, 12, O, u16>;
impl R {
