...
pub struct R(crate::R<GICD_SPENDSGIRN_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GICD_SPENDSGIRN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GICD_SPENDSGIRN_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GICD_SPENDSGIRN_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GICD_SPENDSGIRn` writer"]
pub struct W(crate::W<GICD_SPENDSGIRN_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GICD_SPENDSGIRN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GICD_SPENDSGIRN_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GICD_SPENDSGIRN_SPEC>) -> Self {
        W(writer)
    }
}
#[cfg(feature = "debug")]
