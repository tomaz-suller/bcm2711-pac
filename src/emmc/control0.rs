...
pub type HCTL_DWIDTH_W<'a, const O: u8> = crate::BitWriter<'a, CONTROL0_SPEC, O>;
...
pub type HCTL_HS_EN_W<'a, const O: u8> = crate::BitWriter<'a, CONTROL0_SPEC, O>;
...
pub type HCTL_8BIT_W<'a, const O: u8> = crate::BitWriter<'a, CONTROL0_SPEC, O>;
...
pub type GAP_STOP_W<'a, const O: u8> = crate::BitWriter<'a, CONTROL0_SPEC, O>;
...
pub type GAP_RESTART_W<'a, const O: u8> = crate::BitWriter<'a, CONTROL0_SPEC, O>;
...
pub type READWAIT_EN_W<'a, const O: u8> = crate::BitWriter<'a, CONTROL0_SPEC, O>;
...
pub type ALT_BOOT_EN_W<'a, const O: u8> = crate::BitWriter<'a, CONTROL0_SPEC, O>;
impl R {
