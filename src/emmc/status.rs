...
pub type CMD_INHIBIT_W<'a, const O: u8> = crate::BitWriter<'a, STATUS_SPEC, O>;
...
pub type DAT_INHIBIT_W<'a, const O: u8> = crate::BitWriter<'a, STATUS_SPEC, O>;
...
pub type DAT_ACTIVE_W<'a, const O: u8> = crate::BitWriter<'a, STATUS_SPEC, O>;
...
pub type WRITE_TRANSFER_W<'a, const O: u8> = crate::BitWriter<'a, STATUS_SPEC, O>;
...
pub type READ_TRANSFER_W<'a, const O: u8> = crate::BitWriter<'a, STATUS_SPEC, O>;
...
pub type BUFFER_WRITE_ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, STATUS_SPEC, O>;
...
pub type BUFFER_READ_ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, STATUS_SPEC, O>;
...
pub type DAT_LEVEL0_W<'a, const O: u8> = crate::FieldWriter<'a, STATUS_SPEC, 4, O>;
#[doc = "Field `CMD_LEVEL` reader - Value of CMD"]
pub type CMD_LEVEL_R = crate::BitReader;
#[doc = "Field `CMD_LEVEL` writer - Value of CMD"]
pub type CMD_LEVEL_W<'a, const O: u8> = crate::BitWriter<'a, STATUS_SPEC, O>;
...
pub type DAT_LEVEL1_W<'a, const O: u8> = crate::FieldWriter<'a, STATUS_SPEC, 4, O>;
impl R {
