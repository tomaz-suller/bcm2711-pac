...
pub type N_PENDING_W<'a, const O: u8> = crate::BitWriter<'a, IIR_SPEC, O>;
...
pub type DATA_READY_W<'a, const O: u8> = crate::BitWriter<'a, IIR_SPEC, O>;
...
pub type TX_READY_W<'a, const O: u8> = crate::BitWriter<'a, IIR_SPEC, O>;
impl R {
