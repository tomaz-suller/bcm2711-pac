...
pub type CSRST_W<'a, const O: u8> = crate::BitWriter<'a, GRSTCTL_SPEC, O>;
#[doc = "Field `HSRST` reader - HCLK soft reset"]
pub type HSRST_R = crate::BitReader;
#[doc = "Field `HSRST` writer - HCLK soft reset"]
pub type HSRST_W<'a, const O: u8> = crate::BitWriter<'a, GRSTCTL_SPEC, O>;
...
pub type FCRST_W<'a, const O: u8> = crate::BitWriter<'a, GRSTCTL_SPEC, O>;
