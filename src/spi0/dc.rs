...
pub type TDREQ_W<'a, const O: u8> = crate::FieldWriter<'a, DC_SPEC, 8, O>;
...
pub type TPANIC_W<'a, const O: u8> = crate::FieldWriter<'a, DC_SPEC, 8, O>;
...
pub type RDREQ_W<'a, const O: u8> = crate::FieldWriter<'a, DC_SPEC, 8, O>;
...
pub type RPANIC_W<'a, const O: u8> = crate::FieldWriter<'a, DC_SPEC, 8, O>;
impl R {
