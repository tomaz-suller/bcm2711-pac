...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("GPEDS1")
            ...
            .field("eds54", &format_args!("{}", self.eds54().bit()))
            .field("eds55", &format_args!("{}", self.eds55().bit()))
            .field("eds56", &format_args!("{}", self.eds56().bit()))
            .field("eds57", &format_args!("{}", self.eds57().bit()))
            .finish()
    }
}
#[cfg(feature = "debug")]
