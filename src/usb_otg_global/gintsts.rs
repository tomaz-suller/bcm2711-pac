...
pub type MMIS_W<'a, const O: u8> = crate::BitWriter<'a, GINTSTS_SPEC, O>;
...
pub type ESUSP_W<'a, const O: u8> = crate::BitWriter<'a, GINTSTS_SPEC, O>;
...
pub type ENUMDNE_W<'a, const O: u8> = crate::BitWriter<'a, GINTSTS_SPEC, O>;
...
pub type ISOODRP_W<'a, const O: u8> = crate::BitWriter<'a, GINTSTS_SPEC, O>;
...
pub type IISOIXFR_W<'a, const O: u8> = crate::BitWriter<'a, GINTSTS_SPEC, O>;
...
pub type PXFR_INCOMPISOOUT_W<'a, const O: u8> = crate::BitWriter<'a, GINTSTS_SPEC, O>;
...
pub type DATAFSUSP_W<'a, const O: u8> = crate::BitWriter<'a, GINTSTS_SPEC, O>;
...
pub type CIDSCHG_W<'a, const O: u8> = crate::BitWriter<'a, GINTSTS_SPEC, O>;
...
pub type DISCINT_W<'a, const O: u8> = crate::BitWriter<'a, GINTSTS_SPEC, O>;
...
pub type SRQINT_W<'a, const O: u8> = crate::BitWriter<'a, GINTSTS_SPEC, O>;
...
pub type WKUINT_W<'a, const O: u8> = crate::BitWriter<'a, GINTSTS_SPEC, O>;
impl R {
