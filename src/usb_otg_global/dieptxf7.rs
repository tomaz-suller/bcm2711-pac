...
pub type INEPTXSA_W<'a, const O: u8> = crate::FieldWriter<'a, DIEPTXF7_SPEC, 16, O, u16>;
...
pub type INEPTXFD_W<'a, const O: u8> = crate::FieldWriter<'a, DIEPTXF7_SPEC, 16, O, u16>;
impl R {
