...
pub type DMA_14_W<'a, const O: u8> = crate::FieldWriter<'a, GICD_ITARGETSR31_SPEC, 8, O>;
...
pub type AUX_W<'a, const O: u8> = crate::FieldWriter<'a, GICD_ITARGETSR31_SPEC, 8, O>;
#[doc = "Field `ARM` reader - ARM"]
pub type ARM_R = crate::FieldReader;
#[doc = "Field `ARM` writer - ARM"]
pub type ARM_W<'a, const O: u8> = crate::FieldWriter<'a, GICD_ITARGETSR31_SPEC, 8, O>;
#[doc = "Field `DMA_15` reader - DMA 15"]
pub type DMA_15_R = crate::FieldReader;
#[doc = "Field `DMA_15` writer - DMA 15"]
pub type DMA_15_W<'a, const O: u8> = crate::FieldWriter<'a, GICD_ITARGETSR31_SPEC, 8, O>;
impl R {
    #[doc = "Bits 0:7 - DMA 14"]
    #[inline(always)]
