...
pub type TX0FSA_W<'a, const O: u8> = crate::FieldWriter<'a, TX0FSIZ_PERIPHERAL_SPEC, 16, O, u16>;
...
pub type TX0FD_W<'a, const O: u8> = crate::FieldWriter<'a, TX0FSIZ_PERIPHERAL_SPEC, 16, O, u16>;
impl R {
