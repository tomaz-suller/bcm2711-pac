...
pub type ISP_W<'a, const O: u8> = crate::FieldWriter<'a, GICD_ITARGETSR26_SPEC, 8, O>;
#[doc = "Field `USB` reader - USB"]
pub type USB_R = crate::FieldReader;
#[doc = "Field `USB` writer - USB"]
pub type USB_W<'a, const O: u8> = crate::FieldWriter<'a, GICD_ITARGETSR26_SPEC, 8, O>;
#[doc = "Field `V3D` reader - V3D"]
pub type V3D_R = crate::FieldReader;
#[doc = "Field `V3D` writer - V3D"]
pub type V3D_W<'a, const O: u8> = crate::FieldWriter<'a, GICD_ITARGETSR26_SPEC, 8, O>;
#[doc = "Field `TRANSPOSER` reader - Transposer"]
pub type TRANSPOSER_R = crate::FieldReader;
#[doc = "Field `TRANSPOSER` writer - Transposer"]
pub type TRANSPOSER_W<'a, const O: u8> = crate::FieldWriter<'a, GICD_ITARGETSR26_SPEC, 8, O>;
impl R {
    #[doc = "Bits 0:7 - ISP"]
    #[inline(always)]
