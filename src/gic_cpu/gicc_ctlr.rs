...
pub type ENABLE_GROUP_0_W<'a, const O: u8> = crate::BitWriter<'a, GICC_CTLR_SPEC, O>;
...
pub type ENABLE_GROUP_1_W<'a, const O: u8> = crate::BitWriter<'a, GICC_CTLR_SPEC, O>;
...
pub type ACKCTL_W<'a, const O: u8> = crate::BitWriter<'a, GICC_CTLR_SPEC, O>;
#[doc = "Field `FIQEN` reader - Group 0 triggers FIQ"]
pub type FIQEN_R = crate::BitReader;
#[doc = "Field `FIQEN` writer - Group 0 triggers FIQ"]
pub type FIQEN_W<'a, const O: u8> = crate::BitWriter<'a, GICC_CTLR_SPEC, O>;
...
pub type CBPR_W<'a, const O: u8> = crate::BitWriter<'a, GICC_CTLR_SPEC, O>;
...
pub type FIQBYPDISGRP0_W<'a, const O: u8> = crate::BitWriter<'a, GICC_CTLR_SPEC, O>;
...
pub type IRQBYPDISGRP0_W<'a, const O: u8> = crate::BitWriter<'a, GICC_CTLR_SPEC, O>;
...
pub type FIQBYPDISGRP1_W<'a, const O: u8> = crate::BitWriter<'a, GICC_CTLR_SPEC, O>;
...
pub type IRQBYPDISGRP1_W<'a, const O: u8> = crate::BitWriter<'a, GICC_CTLR_SPEC, O>;
...
pub type EOIMODES_W<'a, const O: u8> = crate::BitWriter<'a, GICC_CTLR_SPEC, O>;
...
pub type EOIMODENS_W<'a, const O: u8> = crate::BitWriter<'a, GICC_CTLR_SPEC, O>;
impl R {
