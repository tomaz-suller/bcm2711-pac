...
pub type NPTXFSA_W<'a, const O: u8> = crate::FieldWriter<'a, GNPTXFSIZ_HOST_SPEC, 16, O, u16>;
...
pub type NPTXFD_W<'a, const O: u8> = crate::FieldWriter<'a, GNPTXFSIZ_HOST_SPEC, 16, O, u16>;
impl R {
