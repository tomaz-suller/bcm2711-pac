...
pub type PWEN1_W<'a, const O: u8> = crate::BitWriter<'a, CTL_SPEC, O>;
...
pub type MODE1_W<'a, const O: u8> = crate::BitWriter<'a, CTL_SPEC, O, MODE1_A>;
...
pub type RPTL1_W<'a, const O: u8> = crate::BitWriter<'a, CTL_SPEC, O>;
...
pub type SBIT1_W<'a, const O: u8> = crate::BitWriter<'a, CTL_SPEC, O>;
...
pub type POLA1_W<'a, const O: u8> = crate::BitWriter<'a, CTL_SPEC, O>;
...
pub type USEF1_W<'a, const O: u8> = crate::BitWriter<'a, CTL_SPEC, O>;
#[doc = "Field `CLRF1` reader - Clear FIFO"]
pub type CLRF1_R = crate::BitReader;
#[doc = "Field `CLRF1` writer - Clear FIFO"]
pub type CLRF1_W<'a, const O: u8> = crate::BitWriter<'a, CTL_SPEC, O>;
...
pub type MSEN1_W<'a, const O: u8> = crate::BitWriter<'a, CTL_SPEC, O>;
#[doc = "Field `PWEN2` reader - Enable channel 2"]
pub type PWEN2_R = crate::BitReader;
#[doc = "Field `PWEN2` writer - Enable channel 2"]
pub type PWEN2_W<'a, const O: u8> = crate::BitWriter<'a, CTL_SPEC, O>;
...
pub type MODE2_W<'a, const O: u8> = crate::BitWriter<'a, CTL_SPEC, O, MODE2_A>;
...
pub type RPTL2_W<'a, const O: u8> = crate::BitWriter<'a, CTL_SPEC, O>;
...
pub type SBIT2_W<'a, const O: u8> = crate::BitWriter<'a, CTL_SPEC, O>;
...
pub type POLA2_W<'a, const O: u8> = crate::BitWriter<'a, CTL_SPEC, O>;
...
pub type USEF2_W<'a, const O: u8> = crate::BitWriter<'a, CTL_SPEC, O>;
...
pub type MSEN2_W<'a, const O: u8> = crate::BitWriter<'a, CTL_SPEC, O>;
impl R {
