...
pub type INTERRUPT_ID_W<'a, const O: u8> = crate::FieldWriter<'a, GICC_HPPIR_SPEC, 10, O, u16>;
...
pub type CPUID_W<'a, const O: u8> = crate::FieldWriter<'a, GICC_HPPIR_SPEC, 3, O>;
impl R {
