...
pub type UART_5_W<'a, const O: u8> = crate::BitWriter<'a, CS_SPEC, O>;
...
pub type UART_4_W<'a, const O: u8> = crate::BitWriter<'a, CS_SPEC, O>;
...
pub type UART_3_W<'a, const O: u8> = crate::BitWriter<'a, CS_SPEC, O>;
...
pub type UART_2_W<'a, const O: u8> = crate::BitWriter<'a, CS_SPEC, O>;
...
pub type UART_0_W<'a, const O: u8> = crate::BitWriter<'a, CS_SPEC, O>;
impl R {
