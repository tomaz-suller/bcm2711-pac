...
impl FSEL40_R {
    ...
    #[doc = "Checks if the value of the field is `SD1_DAT4`"]
    #[inline(always)]
...
pub type FSEL40_W<'a, const O: u8> = crate::FieldWriterSafe<'a, GPFSEL4_SPEC, 3, O, FSEL40_A>;
...
impl FSEL41_R {
    ...
    #[doc = "Checks if the value of the field is `SD1_DAT5`"]
    #[inline(always)]
...
pub type FSEL41_W<'a, const O: u8> = crate::FieldWriterSafe<'a, GPFSEL4_SPEC, 3, O, FSEL41_A>;
...
impl FSEL42_R {
    ...
    #[doc = "Checks if the value of the field is `SD1_DAT6`"]
    #[inline(always)]
...
pub type FSEL42_W<'a, const O: u8> = crate::FieldWriterSafe<'a, GPFSEL4_SPEC, 3, O, FSEL42_A>;
...
impl FSEL43_R {
    ...
    #[doc = "Checks if the value of the field is `SD1_DAT7`"]
    #[inline(always)]
...
pub type FSEL43_W<'a, const O: u8> = crate::FieldWriterSafe<'a, GPFSEL4_SPEC, 3, O, FSEL43_A>;
...
impl FSEL44_R {
    ...
    #[doc = "Checks if the value of the field is `SD_CARD_VOLT`"]
    #[inline(always)]
...
pub type FSEL44_W<'a, const O: u8> = crate::FieldWriterSafe<'a, GPFSEL4_SPEC, 3, O, FSEL44_A>;
impl<'a, const O: u8> FSEL44_W<'a, O> {
    ...
    #[inline(always)]
    pub fn sd_card_volt(self) -> &'a mut W {
...
impl FSEL45_R {
    ...
    #[doc = "Checks if the value of the field is `SD_CARD_PWR0`"]
    #[inline(always)]
...
pub type FSEL45_W<'a, const O: u8> = crate::FieldWriterSafe<'a, GPFSEL4_SPEC, 3, O, FSEL45_A>;
impl<'a, const O: u8> FSEL45_W<'a, O> {
    ...
    #[inline(always)]
    pub fn sd_card_pwr0(self) -> &'a mut W {
...
pub type FSEL46_W<'a, const O: u8> = crate::FieldWriterSafe<'a, GPFSEL4_SPEC, 3, O, FSEL46_A>;
...
pub type FSEL47_W<'a, const O: u8> = crate::FieldWriterSafe<'a, GPFSEL4_SPEC, 3, O, FSEL47_A>;
...
pub type FSEL48_W<'a, const O: u8> = crate::FieldWriterSafe<'a, GPFSEL4_SPEC, 3, O, FSEL48_A>;
...
pub type FSEL49_W<'a, const O: u8> = crate::FieldWriterSafe<'a, GPFSEL4_SPEC, 3, O, FSEL49_A>;
