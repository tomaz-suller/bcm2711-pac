...
pub type RIMIC_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
#[doc = "Field `CTSMIC` writer - CTSMIC"]
pub type CTSMIC_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
#[doc = "Field `DCDMIC` writer - DCDMIC"]
pub type DCDMIC_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
#[doc = "Field `DSRMIC` writer - DSRMIC"]
pub type DSRMIC_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
#[doc = "Field `RXIC` writer - RXIC"]
pub type RXIC_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
#[doc = "Field `TXIC` writer - TXIC"]
pub type TXIC_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
#[doc = "Field `RTIC` writer - RTIC"]
pub type RTIC_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
#[doc = "Field `FEIC` writer - FEIC"]
pub type FEIC_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
#[doc = "Field `PEIC` writer - PEIC"]
pub type PEIC_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
#[doc = "Field `BEIC` writer - BEIC"]
pub type BEIC_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
#[doc = "Field `OEIC` writer - OEIC"]
pub type OEIC_W<'a, const O: u8> = crate::BitWriter<'a, ICR_SPEC, O>;
#[cfg(feature = "debug")]
