...
pub type DSI_1_W<'a, const O: u8> = crate::FieldWriter<'a, GICD_ITARGETSR35_SPEC, 8, O>;
...
pub type PIXEL_VALVE_0_W<'a, const O: u8> = crate::FieldWriter<'a, GICD_ITARGETSR35_SPEC, 8, O>;
...
pub type PIXEL_VALVE_1_2_W<'a, const O: u8> = crate::FieldWriter<'a, GICD_ITARGETSR35_SPEC, 8, O>;
#[doc = "Field `CPR` reader - CPR"]
pub type CPR_R = crate::FieldReader;
#[doc = "Field `CPR` writer - CPR"]
pub type CPR_W<'a, const O: u8> = crate::FieldWriter<'a, GICD_ITARGETSR35_SPEC, 8, O>;
impl R {
    #[doc = "Bits 0:7 - DSI 1"]
    #[inline(always)]
