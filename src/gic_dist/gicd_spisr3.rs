...
#[doc = "Register `GICD_SPISR3` writer"]
pub struct W(crate::W<GICD_SPISR3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GICD_SPISR3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GICD_SPISR3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GICD_SPISR3_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PIXEL_VALVE_3_W<'a, const O: u8> = crate::BitWriter<'a, GICD_SPISR3_SPEC, O>;
...
pub type SPI_BSC_SLAVE_W<'a, const O: u8> = crate::BitWriter<'a, GICD_SPISR3_SPEC, O>;
#[doc = "Field `DSI_1` reader - DSI 1"]
pub type DSI_1_R = crate::BitReader;
#[doc = "Field `DSI_1` writer - DSI 1"]
pub type DSI_1_W<'a, const O: u8> = crate::BitWriter<'a, GICD_SPISR3_SPEC, O>;
...
pub type PIXEL_VALVE_0_W<'a, const O: u8> = crate::BitWriter<'a, GICD_SPISR3_SPEC, O>;
...
pub type ETH_PCIE_SECURE_W<'a, const O: u8> = crate::BitWriter<'a, GICD_SPISR3_SPEC, O>;
impl R {
    #[doc = "Bit 0 - HDMI CEC"]
    #[inline(always)]
...
#[cfg(feature = "debug")]
impl core::fmt::Debug for crate::generic::Reg<GICD_SPISR3_SPEC> {
...
#[doc = "`write(|w| ..)` method takes [gicd_spisr3::W](W) writer structure"]
impl crate::Writable for GICD_SPISR3_SPEC {
    type Writer = W;
