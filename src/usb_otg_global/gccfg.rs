...
pub type PWRDWN_W<'a, const O: u8> = crate::BitWriter<'a, GCCFG_SPEC, O>;
...
pub type I2CPADEN_W<'a, const O: u8> = crate::BitWriter<'a, GCCFG_SPEC, O>;
...
pub type VBUSASEN_W<'a, const O: u8> = crate::BitWriter<'a, GCCFG_SPEC, O>;
...
pub type VBUSBSEN_W<'a, const O: u8> = crate::BitWriter<'a, GCCFG_SPEC, O>;
...
pub type SOFOUTEN_W<'a, const O: u8> = crate::BitWriter<'a, GCCFG_SPEC, O>;
...
pub type NOVBUSSENS_W<'a, const O: u8> = crate::BitWriter<'a, GCCFG_SPEC, O>;
impl R {
