...
pub type PCDET_W<'a, const O: u8> = crate::BitWriter<'a, HPRT_SPEC, O>;
#[doc = "Field `PENA` reader - Port enable"]
pub type PENA_R = crate::BitReader;
#[doc = "Field `PENA` writer - Port enable"]
pub type PENA_W<'a, const O: u8> = crate::BitWriter<'a, HPRT_SPEC, O>;
...
pub type PENCHNG_W<'a, const O: u8> = crate::BitWriter<'a, HPRT_SPEC, O>;
...
pub type PPWR_W<'a, const O: u8> = crate::BitWriter<'a, HPRT_SPEC, O>;
#[doc = "Field `PTCTL` reader - Port test control"]
pub type PTCTL_R = crate::FieldReader;
#[doc = "Field `PTCTL` writer - Port test control"]
pub type PTCTL_W<'a, const O: u8> = crate::FieldWriter<'a, HPRT_SPEC, 4, O>;
