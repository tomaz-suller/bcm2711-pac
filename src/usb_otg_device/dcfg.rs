...
pub type DSPD_W<'a, const O: u8> = crate::FieldWriter<'a, DCFG_SPEC, 2, O>;
...
pub type NZLSOHSK_W<'a, const O: u8> = crate::BitWriter<'a, DCFG_SPEC, O>;
#[doc = "Field `DAD` reader - Device address"]
pub type DAD_R = crate::FieldReader;
#[doc = "Field `DAD` writer - Device address"]
pub type DAD_W<'a, const O: u8> = crate::FieldWriter<'a, DCFG_SPEC, 7, O>;
...
pub type PFIVL_W<'a, const O: u8> = crate::FieldWriter<'a, DCFG_SPEC, 2, O>;
...
pub type PERSCHIVL_W<'a, const O: u8> = crate::FieldWriter<'a, DCFG_SPEC, 2, O>;
impl R {
