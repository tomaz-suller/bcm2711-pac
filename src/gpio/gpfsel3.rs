...
impl FSEL30_R {
    ...
    #[doc = "Checks if the value of the field is `MII_A_CRS`"]
    #[inline(always)]
    pub fn is_mii_a_crs(&self) -> bool {
        *self == FSEL30_A::MII_A_CRS
    }
...
pub type FSEL30_W<'a, const O: u8> = crate::FieldWriterSafe<'a, GPFSEL3_SPEC, 3, O, FSEL30_A>;
impl<'a, const O: u8> FSEL30_W<'a, O> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    ...
    #[inline(always)]
    pub fn mii_a_crs(self) -> &'a mut W {
        self.variant(FSEL30_A::MII_A_CRS)
    }
...
impl FSEL31_R {
    ...
    #[doc = "Checks if the value of the field is `MII_A_COL`"]
    #[inline(always)]
    pub fn is_mii_a_col(&self) -> bool {
        *self == FSEL31_A::MII_A_COL
    }
...
pub type FSEL31_W<'a, const O: u8> = crate::FieldWriterSafe<'a, GPFSEL3_SPEC, 3, O, FSEL31_A>;
impl<'a, const O: u8> FSEL31_W<'a, O> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
    ...
    #[inline(always)]
    pub fn mii_a_col(self) -> &'a mut W {
        self.variant(FSEL31_A::MII_A_COL)
    }
...
impl FSEL32_R {
    ...
    #[doc = "Checks if the value of the field is `SD_CARD_PRES`"]
    #[inline(always)]
    pub fn is_sd_card_pres(&self) -> bool {
        *self == FSEL32_A::SD_CARD_PRES
    }
...
pub type FSEL32_W<'a, const O: u8> = crate::FieldWriterSafe<'a, GPFSEL3_SPEC, 3, O, FSEL32_A>;
impl<'a, const O: u8> FSEL32_W<'a, O> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
    ...
    #[inline(always)]
    pub fn sd_card_pres(self) -> &'a mut W {
        self.variant(FSEL32_A::SD_CARD_PRES)
    }
...
impl FSEL33_R {
    ...
    #[doc = "Checks if the value of the field is `SD_CARD_WRPROT`"]
    #[inline(always)]
    pub fn is_sd_card_wrprot(&self) -> bool {
        *self == FSEL33_A::SD_CARD_WRPROT
    }
...
pub type FSEL33_W<'a, const O: u8> = crate::FieldWriterSafe<'a, GPFSEL3_SPEC, 3, O, FSEL33_A>;
impl<'a, const O: u8> FSEL33_W<'a, O> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
    ...
    #[inline(always)]
    pub fn sd_card_wrprot(self) -> &'a mut W {
        self.variant(FSEL33_A::SD_CARD_WRPROT)
    }
...
impl FSEL34_R {
    ...
    pub fn variant(&self) -> FSEL34_A {
        match self.bits {
            ...
            7 => FSEL34_A::SD1_CLK,
            3 => FSEL34_A::SD_CARD_LED,
            2 => FSEL34_A::RGMII_IRQ,
            _ => unreachable!(),
        }
    }
    #[doc = "Checks if the value of the field is `INPUT`"]
    ...
    pub fn is_sd1_clk(&self) -> bool {
        *self == FSEL34_A::SD1_CLK
    }
    #[doc = "Checks if the value of the field is `SD_CARD_LED`"]
    #[inline(always)]
    pub fn is_sd_card_led(&self) -> bool {
        *self == FSEL34_A::SD_CARD_LED
    }
    #[doc = "Checks if the value of the field is `RGMII_IRQ`"]
    #[inline(always)]
    pub fn is_rgmii_irq(&self) -> bool {
        *self == FSEL34_A::RGMII_IRQ
    }
}
#[doc = "Field `FSEL34` writer - Function Select 34"]
pub type FSEL34_W<'a, const O: u8> = crate::FieldWriterSafe<'a, GPFSEL3_SPEC, 3, O, FSEL34_A>;
impl<'a, const O: u8> FSEL34_W<'a, O> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
    ...
    pub fn sd1_clk(self) -> &'a mut W {
        self.variant(FSEL34_A::SD1_CLK)
    }
    #[doc = "Pin is connected to SD_CARD_LED"]
    #[inline(always)]
    pub fn sd_card_led(self) -> &'a mut W {
        self.variant(FSEL34_A::SD_CARD_LED)
    }
    #[doc = "Pin is connected to RGMII_IRQ"]
    #[inline(always)]
    pub fn rgmii_irq(self) -> &'a mut W {
        self.variant(FSEL34_A::RGMII_IRQ)
    }
}
...
impl FSEL35_R {
    ...
    pub fn is_sd1_cmd(&self) -> bool {
        *self == FSEL35_A::SD1_CMD
    }
    #[doc = "Checks if the value of the field is `RGMII_START_STOP`"]
    #[inline(always)]
    pub fn is_rgmii_start_stop(&self) -> bool {
        *self == FSEL35_A::RGMII_START_STOP
    }
...
pub type FSEL35_W<'a, const O: u8> = crate::FieldWriterSafe<'a, GPFSEL3_SPEC, 3, O, FSEL35_A>;
impl<'a, const O: u8> FSEL35_W<'a, O> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
    ...
    pub fn sd1_cmd(self) -> &'a mut W {
        self.variant(FSEL35_A::SD1_CMD)
    }
    #[doc = "Pin is connected to RGMII_START_STOP"]
    #[inline(always)]
    pub fn rgmii_start_stop(self) -> &'a mut W {
        self.variant(FSEL35_A::RGMII_START_STOP)
    }
...
impl FSEL36_R {
    ...
    pub fn variant(&self) -> FSEL36_A {
        match self.bits {
            ...
            6 => FSEL36_A::TXD0,
            7 => FSEL36_A::SD1_DAT0,
            3 => FSEL36_A::RGMII_RX_OK,
            2 => FSEL36_A::MII_A_RX_ERR,
            _ => unreachable!(),
        }
    }
    #[doc = "Checks if the value of the field is `INPUT`"]
    ...
    pub fn is_sd1_dat0(&self) -> bool {
        *self == FSEL36_A::SD1_DAT0
    }
    #[doc = "Checks if the value of the field is `RGMII_RX_OK`"]
    #[inline(always)]
    pub fn is_rgmii_rx_ok(&self) -> bool {
        *self == FSEL36_A::RGMII_RX_OK
    }
    #[doc = "Checks if the value of the field is `MII_A_RX_ERR`"]
    #[inline(always)]
    pub fn is_mii_a_rx_err(&self) -> bool {
        *self == FSEL36_A::MII_A_RX_ERR
    }
}
#[doc = "Field `FSEL36` writer - Function Select 36"]
pub type FSEL36_W<'a, const O: u8> = crate::FieldWriterSafe<'a, GPFSEL3_SPEC, 3, O, FSEL36_A>;
impl<'a, const O: u8> FSEL36_W<'a, O> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
    ...
    pub fn sd1_dat0(self) -> &'a mut W {
        self.variant(FSEL36_A::SD1_DAT0)
    }
    #[doc = "Pin is connected to RGMII_RX_OK"]
    #[inline(always)]
    pub fn rgmii_rx_ok(self) -> &'a mut W {
        self.variant(FSEL36_A::RGMII_RX_OK)
    }
    #[doc = "Pin is connected to MII_A_RX_ERR"]
    #[inline(always)]
    pub fn mii_a_rx_err(self) -> &'a mut W {
        self.variant(FSEL36_A::MII_A_RX_ERR)
    }
}
...
impl FSEL37_R {
    ...
    pub fn variant(&self) -> FSEL37_A {
        match self.bits {
            ...
            6 => FSEL37_A::RXD0,
            7 => FSEL37_A::SD1_DAT1,
            3 => FSEL37_A::RGMII_MDIO,
            2 => FSEL37_A::MII_A_TX_ERR,
            _ => unreachable!(),
        }
    }
    #[doc = "Checks if the value of the field is `INPUT`"]
...
impl FSEL38_R {
    ...
    pub fn variant(&self) -> FSEL38_A {
        match self.bits {
            ...
            6 => FSEL38_A::CTS0,
            7 => FSEL38_A::SD1_DAT2,
            3 => FSEL38_A::RGMII_MDC,
            2 => FSEL38_A::MII_A_CRS,
            _ => unreachable!(),
        }
    }
    #[doc = "Checks if the value of the field is `INPUT`"]
    ...
    pub fn is_sd1_dat2(&self) -> bool {
        *self == FSEL38_A::SD1_DAT2
    }
    #[doc = "Checks if the value of the field is `RGMII_MDC`"]
    #[inline(always)]
    pub fn is_rgmii_mdc(&self) -> bool {
        *self == FSEL38_A::RGMII_MDC
    }
    #[doc = "Checks if the value of the field is `MII_A_CRS`"]
    #[inline(always)]
    pub fn is_mii_a_crs(&self) -> bool {
        *self == FSEL38_A::MII_A_CRS
    }
}
#[doc = "Field `FSEL38` writer - Function Select 38"]
pub type FSEL38_W<'a, const O: u8> = crate::FieldWriterSafe<'a, GPFSEL3_SPEC, 3, O, FSEL38_A>;
impl<'a, const O: u8> FSEL38_W<'a, O> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
    ...
    pub fn sd1_dat2(self) -> &'a mut W {
        self.variant(FSEL38_A::SD1_DAT2)
    }
    #[doc = "Pin is connected to RGMII_MDC"]
    #[inline(always)]
    pub fn rgmii_mdc(self) -> &'a mut W {
        self.variant(FSEL38_A::RGMII_MDC)
    }
    #[doc = "Pin is connected to MII_A_CRS"]
    #[inline(always)]
    pub fn mii_a_crs(self) -> &'a mut W {
        self.variant(FSEL38_A::MII_A_CRS)
    }
}
...
impl FSEL39_R {
    ...
    pub fn variant(&self) -> FSEL39_A {
        match self.bits {
            ...
            6 => FSEL39_A::RTS0,
            7 => FSEL39_A::SD1_DAT3,
            3 => FSEL39_A::RGMII_IRQ,
            2 => FSEL39_A::MII_A_COL,
            _ => unreachable!(),
        }
    }
    #[doc = "Checks if the value of the field is `INPUT`"]
    ...
    pub fn is_sd1_dat3(&self) -> bool {
        *self == FSEL39_A::SD1_DAT3
    }
    #[doc = "Checks if the value of the field is `RGMII_IRQ`"]
    #[inline(always)]
    pub fn is_rgmii_irq(&self) -> bool {
        *self == FSEL39_A::RGMII_IRQ
    }
    #[doc = "Checks if the value of the field is `MII_A_COL`"]
    #[inline(always)]
    pub fn is_mii_a_col(&self) -> bool {
        *self == FSEL39_A::MII_A_COL
    }
}
#[doc = "Field `FSEL39` writer - Function Select 39"]
pub type FSEL39_W<'a, const O: u8> = crate::FieldWriterSafe<'a, GPFSEL3_SPEC, 3, O, FSEL39_A>;
impl<'a, const O: u8> FSEL39_W<'a, O> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
    ...
    pub fn sd1_dat3(self) -> &'a mut W {
        self.variant(FSEL39_A::SD1_DAT3)
    }
    #[doc = "Pin is connected to RGMII_IRQ"]
    #[inline(always)]
    pub fn rgmii_irq(self) -> &'a mut W {
        self.variant(FSEL39_A::RGMII_IRQ)
    }
    #[doc = "Pin is connected to MII_A_COL"]
    #[inline(always)]
    pub fn mii_a_col(self) -> &'a mut W {
        self.variant(FSEL39_A::MII_A_COL)
    }
}
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fsel30(&mut self) -> FSEL30_W<0> {
        FSEL30_W::new(self)
    }
    #[doc = "Bits 3:5 - Function Select 31"]
    #[inline(always)]
    #[must_use]
    pub fn fsel31(&mut self) -> FSEL31_W<3> {
        FSEL31_W::new(self)
    }
    #[doc = "Bits 6:8 - Function Select 32"]
    #[inline(always)]
    #[must_use]
    pub fn fsel32(&mut self) -> FSEL32_W<6> {
        FSEL32_W::new(self)
    }
    #[doc = "Bits 9:11 - Function Select 33"]
    #[inline(always)]
    #[must_use]
    pub fn fsel33(&mut self) -> FSEL33_W<9> {
        FSEL33_W::new(self)
    }
    #[doc = "Bits 12:14 - Function Select 34"]
    #[inline(always)]
    #[must_use]
    pub fn fsel34(&mut self) -> FSEL34_W<12> {
        FSEL34_W::new(self)
    }
    #[doc = "Bits 15:17 - Function Select 35"]
    #[inline(always)]
    #[must_use]
    pub fn fsel35(&mut self) -> FSEL35_W<15> {
        FSEL35_W::new(self)
    }
    #[doc = "Bits 18:20 - Function Select 36"]
    #[inline(always)]
    #[must_use]
    pub fn fsel36(&mut self) -> FSEL36_W<18> {
        FSEL36_W::new(self)
    }
    #[doc = "Bits 21:23 - Function Select 37"]
    #[inline(always)]
    #[must_use]
    pub fn fsel37(&mut self) -> FSEL37_W<21> {
        FSEL37_W::new(self)
    }
    #[doc = "Bits 24:26 - Function Select 38"]
    #[inline(always)]
    #[must_use]
    pub fn fsel38(&mut self) -> FSEL38_W<24> {
        FSEL38_W::new(self)
    }
    #[doc = "Bits 27:29 - Function Select 39"]
    #[inline(always)]
    #[must_use]
    pub fn fsel39(&mut self) -> FSEL39_W<27> {
        FSEL39_W::new(self)
    }
