...
impl R {
    ...
    #[inline(always)]
    pub fn len54(&self) -> LEN54_R {
        LEN54_R::new(((self.bits >> 22) & 1) != 0)
    }
    #[doc = "Bit 23 - Low detect enabled 55"]
    #[inline(always)]
    pub fn len55(&self) -> LEN55_R {
        LEN55_R::new(((self.bits >> 23) & 1) != 0)
    }
    #[doc = "Bit 24 - Low detect enabled 56"]
    #[inline(always)]
    pub fn len56(&self) -> LEN56_R {
        LEN56_R::new(((self.bits >> 24) & 1) != 0)
    }
    #[doc = "Bit 25 - Low detect enabled 57"]
    #[inline(always)]
    pub fn len57(&self) -> LEN57_R {
        LEN57_R::new(((self.bits >> 25) & 1) != 0)
    }
}
#[cfg(feature = "debug")]
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("GPLEN1")
            ...
            .field("len54", &format_args!("{}", self.len54().bit()))
            .field("len55", &format_args!("{}", self.len55().bit()))
            .field("len56", &format_args!("{}", self.len56().bit()))
            .field("len57", &format_args!("{}", self.len57().bit()))
            .finish()
    }
}
#[cfg(feature = "debug")]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn len54(&mut self) -> LEN54_W<22> {
        LEN54_W::new(self)
    }
    #[doc = "Bit 23 - Low detect enabled 55"]
    #[inline(always)]
    #[must_use]
    pub fn len55(&mut self) -> LEN55_W<23> {
        LEN55_W::new(self)
    }
    #[doc = "Bit 24 - Low detect enabled 56"]
    #[inline(always)]
    #[must_use]
    pub fn len56(&mut self) -> LEN56_W<24> {
        LEN56_W::new(self)
    }
    #[doc = "Bit 25 - Low detect enabled 57"]
    #[inline(always)]
    #[must_use]
    pub fn len57(&mut self) -> LEN57_W<25> {
        LEN57_W::new(self)
    }
