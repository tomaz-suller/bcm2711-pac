...
pub type XFRCM_W<'a, const O: u8> = crate::BitWriter<'a, DOEPEACHMSK1_SPEC, O>;
...
pub type EPDM_W<'a, const O: u8> = crate::BitWriter<'a, DOEPEACHMSK1_SPEC, O>;
#[doc = "Field `TOM` reader - Timeout condition mask"]
pub type TOM_R = crate::BitReader;
#[doc = "Field `TOM` writer - Timeout condition mask"]
pub type TOM_W<'a, const O: u8> = crate::BitWriter<'a, DOEPEACHMSK1_SPEC, O>;
...
pub type ITTXFEMSK_W<'a, const O: u8> = crate::BitWriter<'a, DOEPEACHMSK1_SPEC, O>;
...
pub type INEPNMM_W<'a, const O: u8> = crate::BitWriter<'a, DOEPEACHMSK1_SPEC, O>;
...
pub type INEPNEM_W<'a, const O: u8> = crate::BitWriter<'a, DOEPEACHMSK1_SPEC, O>;
...
pub type TXFURM_W<'a, const O: u8> = crate::BitWriter<'a, DOEPEACHMSK1_SPEC, O>;
#[doc = "Field `BIM` reader - BNA interrupt mask"]
pub type BIM_R = crate::BitReader;
#[doc = "Field `BIM` writer - BNA interrupt mask"]
pub type BIM_W<'a, const O: u8> = crate::BitWriter<'a, DOEPEACHMSK1_SPEC, O>;
