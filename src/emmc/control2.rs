...
pub type UHSMODE_W<'a, const O: u8> = crate::FieldWriter<'a, CONTROL2_SPEC, 3, O, UHSMODE_A>;
...
pub type TUNEON_W<'a, const O: u8> = crate::BitWriter<'a, CONTROL2_SPEC, O>;
...
pub type TUNED_W<'a, const O: u8> = crate::BitWriter<'a, CONTROL2_SPEC, O>;
impl R {
