...
pub type DIVF_W<'a, const O: u8> = crate::FieldWriter<'a, DIV_SPEC, 12, O, u16>;
...
pub type DIVI_W<'a, const O: u8> = crate::FieldWriter<'a, DIV_SPEC, 12, O, u16>;
...
pub type PASSWD_W<'a, const O: u8> = crate::FieldWriter<'a, DIV_SPEC, 8, O, PASSWD_AW>;
