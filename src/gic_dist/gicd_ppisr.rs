...
pub type ID29_W<'a, const O: u8> = crate::BitWriter<'a, GICD_PPISR_SPEC, O>;
...
pub type ID30_W<'a, const O: u8> = crate::BitWriter<'a, GICD_PPISR_SPEC, O>;
#[doc = "Field `ID31` reader - nLEGACYIRQ signal"]
pub type ID31_R = crate::BitReader;
#[doc = "Field `ID31` writer - nLEGACYIRQ signal"]
pub type ID31_W<'a, const O: u8> = crate::BitWriter<'a, GICD_PPISR_SPEC, O>;
impl R {
