...
pub type TM_BLKCNT_EN_W<'a, const O: u8> = crate::BitWriter<'a, CMDTM_SPEC, O>;
...
pub type TM_AUTO_CMD_EN_W<'a, const O: u8> =
    crate::FieldWriter<'a, CMDTM_SPEC, 2, O, TM_AUTO_CMD_EN_A>;
...
pub type TM_DAT_DIR_W<'a, const O: u8> = crate::BitWriter<'a, CMDTM_SPEC, O, TM_DAT_DIR_A>;
...
pub type TM_MULTI_BLOCK_W<'a, const O: u8> = crate::BitWriter<'a, CMDTM_SPEC, O, TM_MULTI_BLOCK_A>;
...
pub type CMD_RSPNS_TYPE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, CMDTM_SPEC, 2, O, RESPONSE_A>;
...
pub type CMD_CRCCHK_EN_W<'a, const O: u8> = crate::BitWriter<'a, CMDTM_SPEC, O>;
...
pub type CMD_IXCHK_EN_W<'a, const O: u8> = crate::BitWriter<'a, CMDTM_SPEC, O>;
...
pub type CMD_ISDATA_W<'a, const O: u8> = crate::BitWriter<'a, CMDTM_SPEC, O>;
...
pub type CMD_TYPE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, CMDTM_SPEC, 2, O, CMD_TYPE_A>;
...
pub type CMD_INDEX_W<'a, const O: u8> = crate::FieldWriter<'a, CMDTM_SPEC, 6, O>;
impl R {
