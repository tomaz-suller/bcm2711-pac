...
pub type BLKSIZE_W<'a, const O: u8> = crate::FieldWriter<'a, BLKSIZECNT_SPEC, 10, O, u16>;
...
pub type BLKCNT_W<'a, const O: u8> = crate::FieldWriter<'a, BLKSIZECNT_SPEC, 16, O, u16>;
impl R {
