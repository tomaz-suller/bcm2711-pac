...
pub type CMD_DONE_W<'a, const O: u8> = crate::BitWriter<'a, IRPT_EN_SPEC, O>;
...
pub type DATA_DONE_W<'a, const O: u8> = crate::BitWriter<'a, IRPT_EN_SPEC, O>;
...
pub type BLOCK_GAP_W<'a, const O: u8> = crate::BitWriter<'a, IRPT_EN_SPEC, O>;
...
pub type WRITE_RDY_W<'a, const O: u8> = crate::BitWriter<'a, IRPT_EN_SPEC, O>;
...
pub type READ_RDY_W<'a, const O: u8> = crate::BitWriter<'a, IRPT_EN_SPEC, O>;
...
pub type CARD_W<'a, const O: u8> = crate::BitWriter<'a, IRPT_EN_SPEC, O>;
...
pub type RETUNE_W<'a, const O: u8> = crate::BitWriter<'a, IRPT_EN_SPEC, O>;
...
pub type BOOTACK_W<'a, const O: u8> = crate::BitWriter<'a, IRPT_EN_SPEC, O>;
...
pub type ENDBOOT_W<'a, const O: u8> = crate::BitWriter<'a, IRPT_EN_SPEC, O>;
#[doc = "Field `CTO_ERR` reader - Command timeout"]
pub type CTO_ERR_R = crate::BitReader;
#[doc = "Field `CTO_ERR` writer - Command timeout"]
pub type CTO_ERR_W<'a, const O: u8> = crate::BitWriter<'a, IRPT_EN_SPEC, O>;
...
pub type CCRC_ERR_W<'a, const O: u8> = crate::BitWriter<'a, IRPT_EN_SPEC, O>;
...
pub type CEND_ERR_W<'a, const O: u8> = crate::BitWriter<'a, IRPT_EN_SPEC, O>;
...
pub type DEND_ERR_W<'a, const O: u8> = crate::BitWriter<'a, IRPT_EN_SPEC, O>;
...
pub type ACMD_ERR_W<'a, const O: u8> = crate::BitWriter<'a, IRPT_EN_SPEC, O>;
impl R {
