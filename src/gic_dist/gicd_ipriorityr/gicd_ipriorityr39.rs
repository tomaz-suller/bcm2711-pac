...
pub type CPG_W<'a, const O: u8> = crate::FieldWriter<'a, GICD_IPRIORITYR39_SPEC, 8, O>;
#[doc = "Field `RNG` reader - RNG"]
pub type RNG_R = crate::FieldReader;
#[doc = "Field `RNG` writer - RNG"]
pub type RNG_W<'a, const O: u8> = crate::FieldWriter<'a, GICD_IPRIORITYR39_SPEC, 8, O>;
#[doc = "Field `EMMC` reader - OR of EMMC and EMMC2"]
pub type EMMC_R = crate::FieldReader;
#[doc = "Field `EMMC` writer - OR of EMMC and EMMC2"]
pub type EMMC_W<'a, const O: u8> = crate::FieldWriter<'a, GICD_IPRIORITYR39_SPEC, 8, O>;
...
pub type ETH_PCIE_SECURE_W<'a, const O: u8> = crate::FieldWriter<'a, GICD_IPRIORITYR39_SPEC, 8, O>;
impl R {
    #[doc = "Bits 0:7 - CPG"]
    #[inline(always)]
