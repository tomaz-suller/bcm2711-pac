...
pub type SLOT_STATUS_W<'a, const O: u8> = crate::FieldWriter<'a, SLOTISR_VER_SPEC, 8, O>;
...
pub type SDVERSION_W<'a, const O: u8> = crate::FieldWriter<'a, SLOTISR_VER_SPEC, 8, O>;
...
pub type VENDOR_W<'a, const O: u8> = crate::FieldWriter<'a, SLOTISR_VER_SPEC, 8, O>;
impl R {
