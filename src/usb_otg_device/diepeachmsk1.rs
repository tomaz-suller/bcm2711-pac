...
pub type XFRCM_W<'a, const O: u8> = crate::BitWriter<'a, DIEPEACHMSK1_SPEC, O>;
...
pub type EPDM_W<'a, const O: u8> = crate::BitWriter<'a, DIEPEACHMSK1_SPEC, O>;
...
pub type TOM_W<'a, const O: u8> = crate::BitWriter<'a, DIEPEACHMSK1_SPEC, O>;
...
pub type ITTXFEMSK_W<'a, const O: u8> = crate::BitWriter<'a, DIEPEACHMSK1_SPEC, O>;
...
pub type INEPNMM_W<'a, const O: u8> = crate::BitWriter<'a, DIEPEACHMSK1_SPEC, O>;
