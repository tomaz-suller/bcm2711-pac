...
pub type XFRCM_W<'a, const O: u8> = crate::BitWriter<'a, DOEPMSK_SPEC, O>;
...
pub type EPDM_W<'a, const O: u8> = crate::BitWriter<'a, DOEPMSK_SPEC, O>;
#[doc = "Field `STUPM` reader - SETUP phase done mask"]
pub type STUPM_R = crate::BitReader;
#[doc = "Field `STUPM` writer - SETUP phase done mask"]
pub type STUPM_W<'a, const O: u8> = crate::BitWriter<'a, DOEPMSK_SPEC, O>;
...
pub type OTEPDM_W<'a, const O: u8> = crate::BitWriter<'a, DOEPMSK_SPEC, O>;
