...
pub type XFRC_W<'a, const O: u8> = crate::BitWriter<'a, DIEPINT_SPEC, O>;
...
pub type EPDISD_W<'a, const O: u8> = crate::BitWriter<'a, DIEPINT_SPEC, O>;
#[doc = "Field `TOC` reader - Timeout condition"]
pub type TOC_R = crate::BitReader;
#[doc = "Field `TOC` writer - Timeout condition"]
pub type TOC_W<'a, const O: u8> = crate::BitWriter<'a, DIEPINT_SPEC, O>;
...
pub type ITTXFE_W<'a, const O: u8> = crate::BitWriter<'a, DIEPINT_SPEC, O>;
...
pub type INEPNE_W<'a, const O: u8> = crate::BitWriter<'a, DIEPINT_SPEC, O>;
...
pub type TXFIFOUDRN_W<'a, const O: u8> = crate::BitWriter<'a, DIEPINT_SPEC, O>;
...
pub type BNA_W<'a, const O: u8> = crate::BitWriter<'a, DIEPINT_SPEC, O>;
