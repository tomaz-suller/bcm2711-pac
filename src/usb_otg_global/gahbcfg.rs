...
pub type GINT_W<'a, const O: u8> = crate::BitWriter<'a, GAHBCFG_SPEC, O>;
...
pub type AXI_BURST_W<'a, const O: u8> = crate::FieldWriterSafe<'a, GAHBCFG_SPEC, 2, O, BURST_A>;
...
pub type AXI_WAIT_W<'a, const O: u8> = crate::BitWriter<'a, GAHBCFG_SPEC, O>;
...
pub type TXFELVL_W<'a, const O: u8> = crate::BitWriter<'a, GAHBCFG_SPEC, O>;
...
pub type PTXFELVL_W<'a, const O: u8> = crate::BitWriter<'a, GAHBCFG_SPEC, O>;
impl R {
