...
pub type DATA_READY_W<'a, const O: u8> = crate::BitWriter<'a, LSR_SPEC, O>;
...
pub type RX_OVERRUN_W<'a, const O: u8> = crate::BitWriter<'a, LSR_SPEC, O>;
...
pub type TX_EMPTY_W<'a, const O: u8> = crate::BitWriter<'a, LSR_SPEC, O>;
...
pub type TX_IDLE_W<'a, const O: u8> = crate::BitWriter<'a, LSR_SPEC, O>;
impl R {
