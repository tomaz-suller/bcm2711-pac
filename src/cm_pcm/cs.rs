...
pub type SRC_W<'a, const O: u8> = crate::FieldWriter<'a, CS_SPEC, 4, O, SRC_A>;
...
pub type ENAB_W<'a, const O: u8> = crate::BitWriter<'a, CS_SPEC, O>;
...
pub type KILL_W<'a, const O: u8> = crate::BitWriter<'a, CS_SPEC, O>;
...
pub type FLIP_W<'a, const O: u8> = crate::BitWriter<'a, CS_SPEC, O>;
...
pub type MASH_W<'a, const O: u8> = crate::FieldWriter<'a, CS_SPEC, 2, O>;
...
pub type PASSWD_W<'a, const O: u8> = crate::FieldWriter<'a, CS_SPEC, 8, O, PASSWD_AW>;
