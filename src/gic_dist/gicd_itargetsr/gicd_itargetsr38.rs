...
pub type SDHOST_W<'a, const O: u8> = crate::FieldWriter<'a, GICD_ITARGETSR38_SPEC, 8, O>;
#[doc = "Field `UART` reader - OR of all PL011 UARTs"]
pub type UART_R = crate::FieldReader;
#[doc = "Field `UART` writer - OR of all PL011 UARTs"]
pub type UART_W<'a, const O: u8> = crate::FieldWriter<'a, GICD_ITARGETSR38_SPEC, 8, O>;
...
pub type ETH_PCIE_W<'a, const O: u8> = crate::FieldWriter<'a, GICD_ITARGETSR38_SPEC, 8, O>;
#[doc = "Field `VEC` reader - VEC"]
pub type VEC_R = crate::FieldReader;
#[doc = "Field `VEC` writer - VEC"]
pub type VEC_W<'a, const O: u8> = crate::FieldWriter<'a, GICD_ITARGETSR38_SPEC, 8, O>;
impl R {
    #[doc = "Bits 0:7 - SDHOST"]
    #[inline(always)]
