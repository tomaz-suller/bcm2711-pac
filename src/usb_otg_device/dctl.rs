...
pub type RWUSIG_W<'a, const O: u8> = crate::BitWriter<'a, DCTL_SPEC, O>;
#[doc = "Field `SDIS` reader - Soft disconnect"]
pub type SDIS_R = crate::BitReader;
#[doc = "Field `SDIS` writer - Soft disconnect"]
pub type SDIS_W<'a, const O: u8> = crate::BitWriter<'a, DCTL_SPEC, O>;
...
pub type TCTL_W<'a, const O: u8> = crate::FieldWriter<'a, DCTL_SPEC, 3, O>;
#[doc = "Field `SGINAK` writer - Set global IN NAK"]
pub type SGINAK_W<'a, const O: u8> = crate::BitWriter<'a, DCTL_SPEC, O>;
#[doc = "Field `CGINAK` writer - Clear global IN NAK"]
pub type CGINAK_W<'a, const O: u8> = crate::BitWriter<'a, DCTL_SPEC, O>;
#[doc = "Field `SGONAK` writer - Set global OUT NAK"]
pub type SGONAK_W<'a, const O: u8> = crate::BitWriter<'a, DCTL_SPEC, O>;
#[doc = "Field `CGONAK` writer - Clear global OUT NAK"]
pub type CGONAK_W<'a, const O: u8> = crate::BitWriter<'a, DCTL_SPEC, O>;
...
pub type POPRGDNE_W<'a, const O: u8> = crate::BitWriter<'a, DCTL_SPEC, O>;
impl R {
