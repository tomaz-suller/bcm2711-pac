...
pub type RX_ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, CNTL_SPEC, O>;
#[doc = "Field `TX_ENABLE` reader - Enable transmit"]
pub type TX_ENABLE_R = crate::BitReader;
#[doc = "Field `TX_ENABLE` writer - Enable transmit"]
pub type TX_ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, CNTL_SPEC, O>;
...
pub type RTS_ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, CNTL_SPEC, O>;
...
pub type CTS_ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, CNTL_SPEC, O>;
...
pub type RTS_FIFO_LEVEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, CNTL_SPEC, 2, O, FIFO_LEVEL_A>;
...
pub type CTS_ASSERT_W<'a, const O: u8> = crate::BitWriter<'a, CNTL_SPEC, O, ASSERT_LEVEL_A>;
