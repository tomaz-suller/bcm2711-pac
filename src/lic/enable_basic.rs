...
pub type ARM_ADDRESS_ERROR_W<'a, const O: u8> = crate::BitWriter1S<'a, ENABLE_BASIC_SPEC, O>;
...
pub type ARM_AXI_ERROR_W<'a, const O: u8> = crate::BitWriter1S<'a, ENABLE_BASIC_SPEC, O>;
impl R {
