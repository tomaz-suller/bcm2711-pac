...
pub type TOCAL_W<'a, const O: u8> = crate::FieldWriter<'a, GUSBCFG_SPEC, 3, O>;
...
pub type PHYIF_W<'a, const O: u8> = crate::BitWriter<'a, GUSBCFG_SPEC, O, PHYIF_A>;
...
pub type PHYTYPE_W<'a, const O: u8> = crate::BitWriter<'a, GUSBCFG_SPEC, O, PHYTYPE_A>;
...
pub type FSIF_W<'a, const O: u8> = crate::BitWriter<'a, GUSBCFG_SPEC, O, FSIF_A>;
...
pub type PHYSEL_W<'a, const O: u8> = crate::BitWriter<'a, GUSBCFG_SPEC, O, PHYSEL_A>;
...
pub type DDRSEL_W<'a, const O: u8> = crate::BitWriter<'a, GUSBCFG_SPEC, O, DDRSEL_A>;
...
pub type TRDT_W<'a, const O: u8> = crate::FieldWriter<'a, GUSBCFG_SPEC, 4, O>;
...
pub type PHYLPCS_W<'a, const O: u8> = crate::BitWriter<'a, GUSBCFG_SPEC, O>;
...
pub type ULPIFSLS_W<'a, const O: u8> = crate::BitWriter<'a, GUSBCFG_SPEC, O>;
#[doc = "Field `ULPIAR` reader - ULPI Auto-resume"]
pub type ULPIAR_R = crate::BitReader;
#[doc = "Field `ULPIAR` writer - ULPI Auto-resume"]
pub type ULPIAR_W<'a, const O: u8> = crate::BitWriter<'a, GUSBCFG_SPEC, O>;
...
pub type ULPICSM_W<'a, const O: u8> = crate::BitWriter<'a, GUSBCFG_SPEC, O>;
...
pub type ULPIEVBUSD_W<'a, const O: u8> = crate::BitWriter<'a, GUSBCFG_SPEC, O>;
...
pub type ULPIEVBUSI_W<'a, const O: u8> = crate::BitWriter<'a, GUSBCFG_SPEC, O>;
...
pub type ULPIIPD_W<'a, const O: u8> = crate::BitWriter<'a, GUSBCFG_SPEC, O>;
#[doc = "Field `FHMOD` reader - Forced host mode"]
pub type FHMOD_R = crate::BitReader;
#[doc = "Field `FHMOD` writer - Forced host mode"]
pub type FHMOD_W<'a, const O: u8> = crate::BitWriter<'a, GUSBCFG_SPEC, O>;
...
pub type FDMOD_W<'a, const O: u8> = crate::BitWriter<'a, GUSBCFG_SPEC, O>;
#[doc = "Field `CTXPKT` reader - Corrupt Tx packet"]
pub type CTXPKT_R = crate::BitReader;
#[doc = "Field `CTXPKT` writer - Corrupt Tx packet"]
pub type CTXPKT_W<'a, const O: u8> = crate::BitWriter<'a, GUSBCFG_SPEC, O>;
impl R {
