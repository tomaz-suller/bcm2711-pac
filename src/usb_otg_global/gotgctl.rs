...
pub type SRQ_W<'a, const O: u8> = crate::BitWriter<'a, GOTGCTL_SPEC, O>;
...
pub type HNPRQ_W<'a, const O: u8> = crate::BitWriter<'a, GOTGCTL_SPEC, O>;
...
pub type HSHNPEN_W<'a, const O: u8> = crate::BitWriter<'a, GOTGCTL_SPEC, O>;
#[doc = "Field `DHNPEN` reader - Device HNP enabled"]
pub type DHNPEN_R = crate::BitReader;
#[doc = "Field `DHNPEN` writer - Device HNP enabled"]
pub type DHNPEN_W<'a, const O: u8> = crate::BitWriter<'a, GOTGCTL_SPEC, O>;
