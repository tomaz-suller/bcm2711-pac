...
pub struct R(crate::R<GICD_ITARGETSR12_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GICD_ITARGETSR12_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GICD_ITARGETSR12_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GICD_ITARGETSR12_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GICD_ITARGETSR12` writer"]
pub struct W(crate::W<GICD_ITARGETSR12_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GICD_ITARGETSR12_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GICD_ITARGETSR12_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GICD_ITARGETSR12_SPEC>) -> Self {
        W(writer)
    }
}
...
#[cfg(feature = "debug")]
impl core::fmt::Debug for crate::generic::Reg<GICD_ITARGETSR12_SPEC> {
...
#[doc = "Interrupt Processor Target 48 - 51\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [gicd_itargetsr12](index.html) module"]
pub struct GICD_ITARGETSR12_SPEC;
impl crate::RegisterSpec for GICD_ITARGETSR12_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [gicd_itargetsr12::R](R) reader structure"]
impl crate::Readable for GICD_ITARGETSR12_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [gicd_itargetsr12::W](W) writer structure"]
impl crate::Writable for GICD_ITARGETSR12_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets GICD_ITARGETSR12 to value 0"]
impl crate::Resettable for GICD_ITARGETSR12_SPEC {
