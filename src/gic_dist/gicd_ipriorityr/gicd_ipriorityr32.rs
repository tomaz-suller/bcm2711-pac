...
pub type HDMI_CEC_W<'a, const O: u8> = crate::FieldWriter<'a, GICD_IPRIORITYR32_SPEC, 8, O>;
#[doc = "Field `HVS` reader - HVS"]
pub type HVS_R = crate::FieldReader;
#[doc = "Field `HVS` writer - HVS"]
pub type HVS_W<'a, const O: u8> = crate::FieldWriter<'a, GICD_IPRIORITYR32_SPEC, 8, O>;
#[doc = "Field `RPIVID` reader - RPIVID"]
pub type RPIVID_R = crate::FieldReader;
#[doc = "Field `RPIVID` writer - RPIVID"]
pub type RPIVID_W<'a, const O: u8> = crate::FieldWriter<'a, GICD_IPRIORITYR32_SPEC, 8, O>;
#[doc = "Field `SDC` reader - SDC"]
pub type SDC_R = crate::FieldReader;
#[doc = "Field `SDC` writer - SDC"]
pub type SDC_W<'a, const O: u8> = crate::FieldWriter<'a, GICD_IPRIORITYR32_SPEC, 8, O>;
impl R {
