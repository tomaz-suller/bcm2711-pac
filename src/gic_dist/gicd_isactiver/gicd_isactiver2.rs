...
pub type ARM_ADDRESS_ERROR_W<'a, const O: u8> = crate::BitWriter1S<'a, GICD_ISACTIVER2_SPEC, O>;
...
#[cfg(feature = "debug")]
impl core::fmt::Debug for crate::generic::Reg<GICD_ISACTIVER2_SPEC> {
