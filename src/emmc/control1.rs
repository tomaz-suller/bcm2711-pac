...
pub type CLK_INTLEN_W<'a, const O: u8> = crate::BitWriter<'a, CONTROL1_SPEC, O>;
...
pub type CLK_EN_W<'a, const O: u8> = crate::BitWriter<'a, CONTROL1_SPEC, O>;
...
pub type CLK_GENSEL_W<'a, const O: u8> = crate::BitWriter<'a, CONTROL1_SPEC, O, CLK_GENSEL_A>;
...
pub type CLK_FREQ_MS2_W<'a, const O: u8> = crate::FieldWriter<'a, CONTROL1_SPEC, 2, O>;
...
pub type CLK_FREQ8_W<'a, const O: u8> = crate::FieldWriter<'a, CONTROL1_SPEC, 8, O>;
...
pub type DATA_TOUNIT_W<'a, const O: u8> = crate::FieldWriter<'a, CONTROL1_SPEC, 4, O>;
...
pub type SRST_HC_W<'a, const O: u8> = crate::BitWriter<'a, CONTROL1_SPEC, O>;
...
pub type SRST_CMD_W<'a, const O: u8> = crate::BitWriter<'a, CONTROL1_SPEC, O>;
...
pub type SRST_DATA_W<'a, const O: u8> = crate::BitWriter<'a, CONTROL1_SPEC, O>;
impl R {
