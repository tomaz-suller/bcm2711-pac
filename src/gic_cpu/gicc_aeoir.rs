...
pub type INTERRUPT_ID_W<'a, const O: u8> = crate::FieldWriter<'a, GICC_AEOIR_SPEC, 10, O, u16>;
#[doc = "Field `CPUID` writer - CPUID that requested a software interrupt, 0 otherwise"]
pub type CPUID_W<'a, const O: u8> = crate::FieldWriter<'a, GICC_AEOIR_SPEC, 3, O>;
#[cfg(feature = "debug")]
