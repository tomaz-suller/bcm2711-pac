...
pub type FE_W<'a, const O: u8> = crate::BitWriter<'a, ECR_SPEC, O>;
#[doc = "Field `PE` writer - PE"]
pub type PE_W<'a, const O: u8> = crate::BitWriter<'a, ECR_SPEC, O>;
#[doc = "Field `BE` writer - BE"]
pub type BE_W<'a, const O: u8> = crate::BitWriter<'a, ECR_SPEC, O>;
#[doc = "Field `OE` writer - OE"]
pub type OE_W<'a, const O: u8> = crate::BitWriter<'a, ECR_SPEC, O>;
#[cfg(feature = "debug")]
