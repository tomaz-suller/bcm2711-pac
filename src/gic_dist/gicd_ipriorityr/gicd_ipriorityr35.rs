...
pub struct R(crate::R<GICD_IPRIORITYR35_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GICD_IPRIORITYR35_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GICD_IPRIORITYR35_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GICD_IPRIORITYR35_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GICD_IPRIORITYR35` writer"]
pub struct W(crate::W<GICD_IPRIORITYR35_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GICD_IPRIORITYR35_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GICD_IPRIORITYR35_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GICD_IPRIORITYR35_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DSI_1_W<'a, const O: u8> = crate::FieldWriter<'a, GICD_IPRIORITYR35_SPEC, 8, O>;
...
pub type PIXEL_VALVE_0_W<'a, const O: u8> = crate::FieldWriter<'a, GICD_IPRIORITYR35_SPEC, 8, O>;
...
pub type PIXEL_VALVE_1_2_W<'a, const O: u8> = crate::FieldWriter<'a, GICD_IPRIORITYR35_SPEC, 8, O>;
#[doc = "Field `CPR` reader - CPR"]
pub type CPR_R = crate::FieldReader;
#[doc = "Field `CPR` writer - CPR"]
pub type CPR_W<'a, const O: u8> = crate::FieldWriter<'a, GICD_IPRIORITYR35_SPEC, 8, O>;
impl R {
    #[doc = "Bits 0:7 - DSI 1"]
    #[inline(always)]
