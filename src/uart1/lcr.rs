...
pub type DATA_SIZE_W<'a, const O: u8> = crate::FieldWriter<'a, LCR_SPEC, 2, O, MODE_A>;
...
pub type BREAK_W<'a, const O: u8> = crate::BitWriter<'a, LCR_SPEC, O>;
...
pub type DLAB_W<'a, const O: u8> = crate::BitWriter<'a, LCR_SPEC, O>;
impl R {
