...
pub type DREQ_W<'a, const O: u8> = crate::FieldWriter<'a, DMAC_SPEC, 8, O>;
...
pub type PANIC_W<'a, const O: u8> = crate::FieldWriter<'a, DMAC_SPEC, 8, O>;
#[doc = "Field `ENAB` reader - DMA enabled"]
pub type ENAB_R = crate::BitReader;
#[doc = "Field `ENAB` writer - DMA enabled"]
pub type ENAB_W<'a, const O: u8> = crate::BitWriter<'a, DMAC_SPEC, O>;
impl R {
