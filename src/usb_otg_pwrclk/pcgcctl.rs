...
pub type STPPCLK_W<'a, const O: u8> = crate::BitWriter<'a, PCGCCTL_SPEC, O>;
...
pub type PHYSUSP_W<'a, const O: u8> = crate::BitWriter<'a, PCGCCTL_SPEC, O>;
...
pub type ENABLE_L1GATING_W<'a, const O: u8> = crate::BitWriter<'a, PCGCCTL_SPEC, O>;
...
pub type PHYSLEEP_W<'a, const O: u8> = crate::BitWriter<'a, PCGCCTL_SPEC, O>;
...
pub type DEEPSLEEP_W<'a, const O: u8> = crate::BitWriter<'a, PCGCCTL_SPEC, O>;
...
pub type RESTOREMODE_W<'a, const O: u8> = crate::BitWriter<'a, PCGCCTL_SPEC, O>;
...
pub type ENEXTNDEDHIBER_W<'a, const O: u8> = crate::BitWriter<'a, PCGCCTL_SPEC, O>;
...
pub type EXTNDEDHIBERNATIONCLAMP_W<'a, const O: u8> = crate::BitWriter<'a, PCGCCTL_SPEC, O>;
...
pub type EXTNDEDHIBERNATIONSWITCH_W<'a, const O: u8> = crate::BitWriter<'a, PCGCCTL_SPEC, O>;
...
pub type ESSREGRESTORED_W<'a, const O: u8> = crate::BitWriter<'a, PCGCCTL_SPEC, O>;
...
pub type RESTORE_VALUE_W<'a, const O: u8> = crate::FieldWriter<'a, PCGCCTL_SPEC, 18, O, u32>;
impl R {
