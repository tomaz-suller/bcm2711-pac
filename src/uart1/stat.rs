...
pub type DATA_READY_W<'a, const O: u8> = crate::BitWriter<'a, STAT_SPEC, O>;
...
pub type TX_READY_W<'a, const O: u8> = crate::BitWriter<'a, STAT_SPEC, O>;
#[doc = "Field `RX_IDLE` reader - Receiver is idle"]
pub type RX_IDLE_R = crate::BitReader;
#[doc = "Field `RX_IDLE` writer - Receiver is idle"]
pub type RX_IDLE_W<'a, const O: u8> = crate::BitWriter<'a, STAT_SPEC, O>;
...
pub type TX_IDLE_W<'a, const O: u8> = crate::BitWriter<'a, STAT_SPEC, O>;
...
pub type RX_OVERRUN_W<'a, const O: u8> = crate::BitWriter<'a, STAT_SPEC, O>;
...
pub type TX_EMPTY_W<'a, const O: u8> = crate::BitWriter<'a, STAT_SPEC, O>;
...
pub type TX_DONE_W<'a, const O: u8> = crate::BitWriter<'a, STAT_SPEC, O>;
...
pub type RX_FIFO_LEVEL_W<'a, const O: u8> = crate::FieldWriter<'a, STAT_SPEC, 4, O>;
...
pub type TX_FIFO_LEVEL_W<'a, const O: u8> = crate::FieldWriter<'a, STAT_SPEC, 4, O>;
impl R {
