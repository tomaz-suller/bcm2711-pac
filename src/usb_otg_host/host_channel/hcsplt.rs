...
pub type COMPLSPLT_W<'a, const O: u8> = crate::BitWriter<'a, HCSPLT_SPEC, O>;
#[doc = "Field `SPLITEN` reader - Split enable"]
pub type SPLITEN_R = crate::BitReader;
#[doc = "Field `SPLITEN` writer - Split enable"]
pub type SPLITEN_W<'a, const O: u8> = crate::BitWriter<'a, HCSPLT_SPEC, O>;
impl R {
