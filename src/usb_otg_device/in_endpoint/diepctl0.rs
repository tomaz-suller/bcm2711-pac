...
pub type MPSIZ_W<'a, const O: u8> = crate::FieldWriter<'a, DIEPCTL0_SPEC, 11, O, u16>;
#[doc = "Field `USBAEP` reader - USB active endpoint"]
pub type USBAEP_R = crate::BitReader;
#[doc = "Field `USBAEP` writer - USB active endpoint"]
pub type USBAEP_W<'a, const O: u8> = crate::BitWriter<'a, DIEPCTL0_SPEC, O>;
...
pub type EPTYP_W<'a, const O: u8> = crate::FieldWriter<'a, DIEPCTL0_SPEC, 2, O>;
...
pub type TXFNUM_W<'a, const O: u8> = crate::FieldWriter<'a, DIEPCTL0_SPEC, 4, O>;
...
pub type SD0PID_SEVNFRM_W<'a, const O: u8> = crate::BitWriter<'a, DIEPCTL0_SPEC, O>;
#[doc = "Field `SODDFRM` writer - Set odd frame"]
pub type SODDFRM_W<'a, const O: u8> = crate::BitWriter<'a, DIEPCTL0_SPEC, O>;
