...
pub type SEDET_W<'a, const O: u8> = crate::BitWriter<'a, GOTGINT_SPEC, O>;
...
pub type SRSSCHG_W<'a, const O: u8> = crate::BitWriter<'a, GOTGINT_SPEC, O>;
...
pub type HNSSCHG_W<'a, const O: u8> = crate::BitWriter<'a, GOTGINT_SPEC, O>;
...
pub type HNGDET_W<'a, const O: u8> = crate::BitWriter<'a, GOTGINT_SPEC, O>;
...
pub type ADTOCHG_W<'a, const O: u8> = crate::BitWriter<'a, GOTGINT_SPEC, O>;
#[doc = "Field `DBCDNE` reader - Debounce done"]
pub type DBCDNE_R = crate::BitReader;
#[doc = "Field `DBCDNE` writer - Debounce done"]
pub type DBCDNE_W<'a, const O: u8> = crate::BitWriter<'a, GOTGINT_SPEC, O>;
impl R {
